  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <? if($nav_current_page=="articles.php") echo 'class="active "' ?>><a href="articles.php"><h3 class="ag-h3">Artiklar</h3></a></li>
        <li <? if($nav_current_page=="paintings.php") echo 'class="active "' ?>><a href="paintings.php"><h3 class="ag-h3">Målningar</h3></a></li>
        <li <? if($nav_current_page=="letters.php") echo 'class="active "' ?>><a href="letters.php"><h3 class="ag-h3">Brev</h3></a></li>
      </ul>
