  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <? if($nav_current_page=="articles.php") echo 'class="active "' ?>><a href="#" ng-click="addTagToSearchByName('Tidningsartikel'); getFilteredArticles()"><h3 class="ag-h3">Tidningsartiklar</h3></a></li>
