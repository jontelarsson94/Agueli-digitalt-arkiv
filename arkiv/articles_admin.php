          ...
          <div class="col-md-12">
            <div class="col-md-10">
              <div ng-repeat="article in articles">
                <div class="col-lg-3 col-md-4 col-sm-6"><div><a href="update_article.php?article_id={{article.id}}"><img src="img/{{main_images[$index].url}}" alt="..." class="img-responsive ag-img-thumbnail ag-big-div ag-card-image"><div class="transparent"><h4 class="ag-overlay-text">{{article.title.substring(0, 24)}}<span ng-if="article.title.length > 24">-</span></h4><h4 class="ag-overlay-text">{{article.title.substring(24, 48)}}</h4></div></img></a></div></div>
              </div>
            </div>
          </div>
        </div>
