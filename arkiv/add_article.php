      ...
      <div class="col-md-8 col-md-offset-2">
            <form action="api/add_article.php" id="add-article-form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10" cols="25" name="body1" id="body1" ng-model="articleData.body1"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10" cols="25" name="body2" id="body2" ng-model="articleData.body2"></textarea>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10" cols="25" name="body3" id="body3" ng-model="articleData.body3"></textarea>
                  </div>
